...
class WindowModel(NERModel):
    ...
    def add_prediction_op(self):
        ...
        self.W = tf.get_variable("W", (self.config.n_window_features * self.config.embed_size, self.config.hidden_size))
        self.b1 = tf.get_variable("b1", (self.config.hidden_size,))
        self.U = tf.get_variable("U", (self.config.hidden_size, self.config.n_classes))
        self.b2 = tf.get_variable("b2", (self.config.n_classes,))
